...
import { openSnackbar } from "../redux/reducers/Slice";
...
const FoodDetails = () => {
  ...
  const addFavourite = async () => {
    ...
    if (!token) {
      alert("Please sign in first to add items to the favourite.");
      return;
    }
  ...
  const addCart = async () => {
    ...
    if (!token) {
      alert("Please sign in first to add items to the cart or place an order.");
      return;
    }
          ...
          <Details>
            ...
            <ButtonWrapper>
              <Button
                ...
                onClick={() => addCart()}
              />
              <Button text="Order Now" full onClick={() => addCart()} />
              <Button
                leftIcon={
                  favorite ? (
